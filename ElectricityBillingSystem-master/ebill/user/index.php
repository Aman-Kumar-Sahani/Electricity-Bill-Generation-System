            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <br>
                        <!-- STATISTICS -->
                        <h1 style="padding-left:30px;" class="text-muted text-centered">S T A T S</h1>
                        <br>
                        ...
                        <button class = "btn btn-primary">Pay New Bills</button>
                        <button class = "btn btn-primary">Download Reciept</button>
